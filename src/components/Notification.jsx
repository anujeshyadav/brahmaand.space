...
function Notification() {
  ...
  //   axios
  //     .get(
  //       `http://13.233.99.196:9000/admin/getone_notification/636df1996358e0e8419332df`
  //     )
  //     .then((res) => {
  ...
  const deletenotification = (id) => {
    console.log(id);
    axios
      .post(`http://13.233.99.196:9000/admin/dlt_notification/${id}`)
      .then((res) => {
  ...
  const notificationhandler = () => {
    axios
      .get(`http://13.233.99.196:9000/admin/get_notification`)
      .then((res) => {
