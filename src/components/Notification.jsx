...
function Notification() {
  ...
  //   axios
  //     .get(
  //       `https://15.207.117.200:9000/admin/getone_notification/636df1996358e0e8419332df`
  //     )
  //     .then((res) => {
  ...
  const deletenotification = (id) => {
    console.log(id);
    axios
      .post(`https://15.207.117.200:9000/admin/dlt_notification/${id}`)
      .then((res) => {
  ...
  const notificationhandler = () => {
    axios
      .get(`https://15.207.117.200:9000/admin/get_notification`)
      .then((res) => {
