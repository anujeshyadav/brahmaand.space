    ...
    <>
      ...
      <Container>
        ...
        <Row>
          ...
          <Form>
            ...
            <div className=" d-flex justify-content-center ">
              <Button className="mt-3" style={{ justifyContent: "center" }}><b>Leave a message</b></Button>
            </div>
          </Form>
        </Row>
        ...
        <Row className="mt-5">
          ...
          <Col className="searchtwo ">
            <div className="searchone">
              <FaBlogger className="lacation d-flex justify-content-center mb-2"
                size={55}
                color="#FC9358" />
          ...
          <Col className="searchtwo st">
            <div className="searchone">
              <BsFillTelephoneFill className="lacation d-flex justify-content-center"
                size={55}
                color="#FC9358" />
