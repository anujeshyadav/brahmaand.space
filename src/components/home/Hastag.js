...
function Hastag() {
  ...
  const gettrendingdata = () => {
    axios
      .get(`http://13.233.99.196:9000/admin/getTrending`)
      .then((res) => {
  ...
  const popularblog = () => {
    axios
      .get(`http://13.233.99.196:9000/user/popularBlog`)
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(`http://13.233.99.196:9000/user/add_news_ltr`, {
        email: email,
        userid: userid,
      })
      .then((response) => {
  ...
  function handlehastagtopic(hastag) {
    ...
    //   console.log(hastag);
    //   axios
    //     .get(`http://13.233.99.196:9000/user/filterbyHashTag/${hastag}`)
    //     .then((res) => {
