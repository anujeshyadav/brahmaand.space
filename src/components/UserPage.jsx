...
import { FaEdit, FaRegHandPointRight, FaInfinity, FaChartBar } from "react-icons/fa";
  ...
  return (
    <div>
     <div className="d-flex loginboard ">
            ...
            <FaEdit size={25} style={{fontFamily: "GT Walsheim Pro"}} color="black" className='mx-3'/>
            Edit Your Profile
            </Link>
            </DropdownItem>
            ...
            <hr />
            <DropdownItem >
            <Link  className='userboard' to="/login">
